    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat DIVI and make it unusable. To
...
bool CObfuscationPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    // CAmount nBalanceNeedsAnonymized = nAnonymizeDIVIAmount * COIN - pwalletMain->GetAnonymizedBalance();
    CAmount nBalanceNeedsAnonymized = nAnonymizeDiviAmount * COIN - pwalletMain->GetAnonymizedBalance();
